...
class OptimisedLayeredGraphViewPage extends StatefulWidget {
  @override
  _OptimisedLayeredGraphViewPageState createState() => _OptimisedLayeredGraphViewPageState();
}

class _OptimisedLayeredGraphViewPageState extends State<OptimisedLayeredGraphViewPage> {
  @override
  ...
  void initState() {
    ...
    graph.addEdge(Node.Id(0), Node.Id(4));
