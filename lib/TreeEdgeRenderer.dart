...
import 'BuchheimWalkerAlgorithm.dart';
        ...
        switch (configuration.orientation) {
          case BuchheimWalkerConfiguration.ORIENTATION_TOP_BOTTOM:
            ...
            linePath.lineTo(child.x + child.width / 2,
                child.y - configuration.levelSeparation / 2);
          ...
          case BuchheimWalkerConfiguration.ORIENTATION_BOTTOM_TOP:
            ...
            linePath.lineTo(child.x + child.width / 2,
                child.y + child.height + configuration.levelSeparation / 2);
            linePath.lineTo(node.x + node.width / 2,
                child.y + child.height + configuration.levelSeparation / 2);
          ...
          case BuchheimWalkerConfiguration.ORIENTATION_LEFT_RIGHT:
            ...
            linePath.lineTo(child.x - configuration.levelSeparation / 2,
                child.y + child.height / 2);
            linePath.lineTo(child.x - configuration.levelSeparation / 2,
                node.y + node.height / 2);

            linePath.moveTo(child.x - configuration.levelSeparation / 2,
                node.y + node.height / 2);
          ...
          case BuchheimWalkerConfiguration.ORIENTATION_RIGHT_LEFT:
            ...
            linePath.lineTo(
                child.x + child.width + configuration.levelSeparation / 2,
                child.y + child.height / 2);
            linePath.lineTo(
                child.x + child.width + configuration.levelSeparation / 2,
                node.y + node.height / 2);
